...
Use OS images in http://temlib.org/pub/mister/SS/ , passwords are the OS names, uppercase and lowercase characters (NeXTSTEP, SunOS, Solaris). You can also make your own images using QEMU, or a real SparcStation.
